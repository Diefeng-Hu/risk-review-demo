...
const CARD_DATA = [
    {
        ...
        reason: '语音内容暗示壮阳功效，违反黑五类规则', focus: true,
        expand: { riskType: 'voice', domain: '大模型精细化-严口径', subDomain: '黑五类', quickTags: ['壮阳暗示','疗效保证','夸大功效','软色情'], activeTag: '壮阳暗示', direction: '去除"使劲""三十分钟"等暗示性词语' }
    },
    {
        ...
        reason: '画面文字暗示性服务，违反硬广严口径规则',
        expand: { riskType: 'text', domain: '大模型精细化-严口径', subDomain: '低俗', quickTags: ['暗示性服务','软色情','违法医疗'], activeTag: '暗示性服务', direction: '移除暗示性文字（按摩服务、预约体检）' }
    },
    {
        ...
        reason: '画面出现蘑菇增长特写，疑似暗示性元素',
        expand: { riskType: 'scene', domain: null, subDomain: null, quickTags: ['暗示元素','软色情','违规符号'], activeTag: '暗示元素', direction: '替换为产品本身画面' }
    },
    {
        ...
        reason: '夸大产品功效，违反硬广严口径', confirmed: true
    },
    {
